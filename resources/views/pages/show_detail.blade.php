...
<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Phân loại:</b> New</p>
								<p><b>Thương hiệu:</b>{{$detail->brand_name}}</p>
                                <p><b>Dang mục:</b>{{$detail->category_name}}</p>
...
@endforeach					
					<div class="recommended_items"><!--recommended_items-->
						...
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								<div class="item active">	
    @foreach($relate as $key => $dexuat)
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
                                                    <img src="{{URL::to('public/uploads/product/'.$dexuat->product_image)}}" alt="" />
													<h2>{{number_format($dexuat->product_price)." "."₫"}}</h2>
